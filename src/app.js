...
function goTo(viewId) {
  ...
  ['g-history-drawer', 'p-history-drawer', 'n-history-drawer', 'c-history-drawer', 'j-history-drawer'].forEach(id => { const d = $(`#${id}`); if (d) d.classList.remove('open'); });
  ['g-history-backdrop', 'p-history-backdrop', 'n-history-backdrop', 'c-history-backdrop', 'j-history-backdrop'].forEach(id => { const b = $(`#${id}`); if (b) b.classList.add('hidden'); });
