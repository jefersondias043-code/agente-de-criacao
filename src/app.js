...
const NAV_ITEMS = [
  ...
  { id: 'm23',       label: 'M23',         icon: '<rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/>' },
  { id: 'matriz',    label: 'Matriz',      icon: '<path d="M3 3h18v18H3z"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/><path d="M15 3v18"/>' },
...
function goTo(viewId) {
  ...
  ['g-history-drawer', 'p-history-drawer', 'n-history-drawer', 'c-history-drawer', 'pk-history-drawer', 'af-history-drawer', 'm23-history-drawer'].forEach(id => { const d = $(`#${id}`); if (d) d.classList.remove('open'); });
  ['g-history-backdrop', 'p-history-backdrop', 'n-history-backdrop', 'c-history-backdrop', 'pk-history-backdrop', 'af-history-backdrop', 'm23-history-backdrop'].forEach(id => { const b = $(`#${id}`); if (b) b.classList.add('hidden'); });
  ...
  if (viewId === 'm23') renderM23();
  if (viewId === 'matriz') renderMatriz();
